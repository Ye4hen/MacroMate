...
@section('content')
    <div class="max-w-6xl mx-auto">
        <div class="flex items-center justify-between mb-4">
            ...
            <x-mm-button href="{{ route('admin.plans.create') }}" variant="accent" label="Add plan"
                    ...
                    @foreach ($plans as $plan)
                        <tr class="border-t border-mm-border">
                            <td class="px-4 py-3 align-middle">
                                <div>
                                    <div class="font-medium text-white">{{ $plan->mp_name }}</div>
                                </div>
                            </td>
                            ...
                            <td class="px-4 py-3 align-middle">
                                <div class="flex items-center gap-2">
                                    <x-mm-button href="{{ route('admin.plans.edit', $plan->mp_code) }}"
