            ...
            <div class="flex items-start justify-end gap-2 flex-wrap">
                ...
                <div class="text-right ml-auto">
                    ...
                    <div class="mt-2">
                        <x-mm-button
                            type="button"
                            class="food-add-btn inline-flex items-center px-3 py-1"
                            data-food-code="{{ $code }}"
                            data-food-unit="{{ $unit_label }}"
                            variant="accent"
                            title="Add {{ $name }}"
                        >
                            <svg
...
@if (! $is_last)
    <div
        class="food-sentinel h-2"
        data-next-url="{{ route("foods.more", ["page" => $page + 1]) }}"
        aria-hidden="true"
    />
@endif
        ...
        (function () {
            async function initFoodInfinite() {
                ...
                const scroll_container =
                    grid_wrapper.querySelector('#food-grid');
                ...
                const first_sentinel =
                    grid_wrapper.querySelector('.food-sentinel');
