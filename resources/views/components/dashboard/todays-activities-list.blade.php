...
<section {{ $attributes->merge([
    ...
    <header class="px-4 py-3 flex items-center justify-between border-b dark:border-slate-700">
        <h3 class="text-lg font-semibold text-slate-800 dark:text-slate-100">Today's Activities</h3>
        ...
        @else
            ...
            <ul class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                @foreach ($activities as $activity)
                    ...
                    @endphp
                    <li class="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-white dark:bg-slate-800 border rounded px-3 py-2">
                        <div class="flex items-center gap-3">
                            <div class="text-sm">
                                <h4 class="font-medium text-slate-800 dark:text-slate-100">{{ $name }}</h4>
