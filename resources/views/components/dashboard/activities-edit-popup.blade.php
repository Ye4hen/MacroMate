    ...
    <div class="relative p-4 w-full max-w-lg h-full md:h-auto mx-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-slate-800">
            ...
            <div class="px-6 py-4">
                ...
                <p
                    id="edit-activity-modal-subtitle"
                        ...
                        <div class="flex-1">
                            ...
                            >
                                ...
                                <input
                                    type="hidden"
                                    name="activity_code"
                                    id="edit-activity-activity-code"
                                    value=""
                                />
                                <input
                                    type="hidden"
                            ...
                            >
                                ...
                                <input
                                    type="hidden"
                                    name="activity_code"
                                    id="remove-activity-activity-code"
                                    value=""
                                />
                                <input
                                    type="hidden"
                                    name="date"
                                    id="remove-activity-date"
                                    value="{{ $date }}"
                                />
