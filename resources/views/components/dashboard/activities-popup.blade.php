            ...
            <div class="p-6 pt-10">
                <div class="flex items-end justify-between flex-wrap gap-4">
                    <div>
                        ...
                        <p
                            id="add-activity-modal-subtitle"
                            class="text-sm text-slate-500 dark:text-slate-400 mt-1"
                        >
                            Select an activity and optionally set duration to
                            calculate calories burned.
                        </p>
                    </div>
                    <x-mm-input
                        name="activity-popup-search"
                ...
                >
                    ...
                    <input
                        type="hidden"
                        name="code"
                        id="add-activity-code"
                        value=""
                    />
                    <input
                        type="hidden"
                        name="time_spent"
                        id="add-activity-time-spent"
                        value=""
                    />
                    <input
                        type="hidden"
...
@pushOnce("scripts")
    <script>
        (function () {
            ...
            async function doSearch(q) {
                ...
                try {
                    ...
                    console.error(err);
                    grid.innerHTML =
                        '<div class="text-sm text-mm-error p-3">Search failed.</div>';
                }
            }
        ...
        (function () {
            ...
            const activity_code_input =
                document.getElementById('add-activity-code');
            const activity_time_spent = document.getElementById(
                'add-activity-time-spent',
            );
            ...
            document.addEventListener('click', function (ev) {
                ...
                const time_input = document.querySelector(
                    `[data-activity-time-input="${activity_code}"]`,
                );
