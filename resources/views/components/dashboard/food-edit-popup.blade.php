    ...
    <div class="relative p-4 w-full max-w-lg h-full md:h-auto mx-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-slate-800">
            <button
                ...
                data-modal-hide="edit-food-in-meal-modal"
            >
            ...
            <div class="px-6 py-4">
                ...
                <p
                    id="edit-food-modal-subtitle"
                    class="text-sm text-slate-500 dark:text-slate-400 mt-1"
                >
                    Adjust quantity or remove the food from the meal.
                </p>
                <div class="mt-4">
                        ...
                        <div class="flex-1">
                            ...
                            >
                                ...
                                <input
                                    type="hidden"
                                    name="meal_code"
                                    id="edit-food-meal-code"
                                    value=""
                                />
                                <input
                                    type="hidden"
                                    name="food_code"
                                    id="edit-food-food-code"
                                    value=""
                                />
                            ...
                            <form
                                id="edit-food-remove-form"
                                method="POST"
                                action="#"
                                class="inline-block mt-2 form-with-loader"
                                onsubmit="return confirm('Remove this food from the meal?');"
                            >
                                @csrf
                                @method("DELETE")
                                <input
                                    type="hidden"
                                    name="food_code"
                                    id="remove-food-food-code"
                                    value=""
                                />
                                <x-mm-button type="submit" variant="secondary">
                                    Remove
                                </x-mm-button>
                            </form>
                        </div>
