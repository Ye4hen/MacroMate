...
class Container_e5e14fa164 extends _PHPStan_6597ef616\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0359(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_e5e14fa164 $container)
			{
	...
	public function createServiceContainer(): Container_e5e14fa164
	{
		return $this;
	}
