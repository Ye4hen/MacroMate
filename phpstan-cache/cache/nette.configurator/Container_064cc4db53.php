...
class Container_064cc4db53 extends _PHPStan_6597ef616\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0359(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_064cc4db53 $container)
			{
	...
	public function createServiceContainer(): Container_064cc4db53
	{
		return $this;
	}
